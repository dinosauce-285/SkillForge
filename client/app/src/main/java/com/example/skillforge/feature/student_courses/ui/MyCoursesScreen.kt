...
fun MyCourseCard(
    ...
    val isCompleted = course.percentage.coerceIn(0, 100) == 100
    ...
    CourseProgressCard(
        ...
        showContinueAction = !isCompleted,
        onContinueClick = onClick,
        showCertificateAction = isCompleted,
        onCertificateClick = onDownloadCertificate
    )
}
